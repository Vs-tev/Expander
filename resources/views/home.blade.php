@extends('layouts.master')
  ...
  <div class="row col-10 mx-auto">
        ...
        <!-- sidebar -->
        @auth
          <div class="col-3 p-0 mt-3 border shadow-sm bg-white sticky-top" style="height: 100%">
          ...
          <div class="col-9 mx-auto">
            ...
            <div class="my-3">
                ...
                <div class="border shadow-sm d-flex align-items-center justify-content-center p-3">
                  ...
                  <a class="pt-2" href="/create">
                  <h5 class="font-weight-600">Create Project or Club startup idea, Share vision for Product</h5>
                </a>
                </div>
